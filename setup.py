...
setup(name = 'GiniClust',
      ...
      author = 'Lan Jiang, Gregory Giecold',
      author_email = "lan_jiang@hms.harvard.edu ggiecold@jimmy.harvard.edu",
      maintainer = 'Lan Jiang, Gregory Giecold',
      maintainer_email = "lan_jiang@hms.harvard.edu "
